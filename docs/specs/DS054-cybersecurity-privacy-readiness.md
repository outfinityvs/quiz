...
| Field | Value |
| --- | --- |
| Public | Startups, SMEs, founders, executive teams, and vendors undergoing customer diligence |
...
| 9 | Govern & Identify | How are critical third-party risks reviewed before adoption or renewal? | A=0 absent/ad hoc/no evidence; B=1 informal or partial; C=2 documented/repeatable; D=3 governed, evidence-backed, or system-level. Public UI must not show points. |
| 10 | Protect | How consistently are access rights removed or reduced when roles change? | A=0 absent/ad hoc/no evidence; B=1 informal or partial; C=2 documented/repeatable; D=3 governed, evidence-backed, or system-level. Public UI must not show points. |
| 11 | Detect & Respond | How quickly can the team tell whether an incident is contained? | A=0 absent/ad hoc/no evidence; B=1 informal or partial; C=2 documented/repeatable; D=3 governed, evidence-backed, or system-level. Public UI must not show points. |
| 12 | Recover & Privacy | How often are restore and privacy-notification assumptions tested? | A=0 absent/ad hoc/no evidence; B=1 informal or partial; C=2 documented/repeatable; D=3 governed, evidence-backed, or system-level. Public UI must not show points. |
